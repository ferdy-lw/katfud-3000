...
/*****************************************************************************
*
*   Function name : BCD22CHAR
*
*   Returns :       char represented by the Binary coded decimal value of the input (2 digits)
*
*   Parameters :    BCD Value between (0-99) to be decoded into char
*
*   Purpose :       Convert a BCD encoded character to a character.
*                   The input is a byte where the high and low nibbles
*                   contain the tens and ones of the input.
*                   The result will be in the range 0 to 99.
*
*****************************************************************************/
char BCD22CHAR(char input)
{
