...
//extern volatile uint8_t gPowerSaveTimer; // RTC
...
/*****************************************************************************
*
*   Function name : isButtonUpOn
*
*   Returns :       true if the up button is currently pressed
*
*   Parameters :    None
*
*   Purpose :       Figure out if we were powered on with the up button
*
*****************************************************************************/
char isButtonUpOn(void) {
